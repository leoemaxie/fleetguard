import { customType, numeric, pgEnum, pgTable, timestamp, uuid } from 'drizzle-orm/pg-core';
...
export const tripStatusEnum = pgEnum('trip_status', ['active', 'completed', 'incomplete']);
...
export const trips = pgTable('trips', {
  ...
  totalFuelUsedLitres: numeric('total_fuel_used_litres', { precision: 8, scale: 2 }),
