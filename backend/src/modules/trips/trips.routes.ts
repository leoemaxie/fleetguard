...
import { closeTripController, getTripController, listTripsController, replayTripController } from './trips.controller.js';
import { ListTripsQuerySchema, TripParams, TripResponseSchema } from './trips.schema.js';
...
const tripsRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.get('/', {
    schema: {
      ...
      response: { 200: z.object({ data: z.array(TripResponseSchema), nextCursor: z.string().nullable(), hasMore: z.boolean() }) }
    }
  }, listTripsController);
